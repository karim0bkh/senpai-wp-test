=== Senpai WP Test ===
Contributors: Amine Safsafi
Donate link: https://senpai.codes
Tags: 
...
1. Upload `senpai-wp-test.php` to the `/wp-content/themes/` directory
1. Activate the theme through the 'Themes' menu in WordPress
1. Place `<?php do_action('senpai_wp_test_hook'); ?>` in your templates
